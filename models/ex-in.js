...
// // Schedule cron job at 9 PM Netherlands time
...
// //     }
// // });
// const { performance } = require('perf_hooks'); // To calculate response time
// const CronJob = require("./models/cronJob");
// // Result API without Redis caching
// app.get("/result-no-cache", async (req, res) => {
//     const start = performance.now(); // Start time
//     try {
//         // Fetch from the database directly without Redis
//         const result = await Scrape.aggregate([
//             {
//                 $sort: { "latestPost.time": -1 } // Sort based on the `time` field in `latestPost`
//             },
...
//         const responseTime = (end - start).toFixed(2); // Calculate response time in milliseconds
...
// //             const responseTime = (end - start).toFixed(2); // Calculate response time

// //             // If results are found in cache, return them with response time
// //             res.status(200).send({ 
// //                 status: true, 
...
// //     // Update categories filtering based on boolean values
// //     let categories = ['Winkels', 'Horeca', 'Verenigingen', 'Bedrijven', 'Evenementen', 'Lifestyle', 'Recreatie', 'Sport', 'Cultuur'].filter(category => entity[category] === true);
...
// //             {
// //                 Bedrijfsnaam: entity.Bedrijfsnaam,
// //                 categories,  // Use the updated categories array
// //                 businessDetails,
// //                 latestPost,
// //             },
